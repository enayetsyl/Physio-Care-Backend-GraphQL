...
describe("User Resolver Integration Tests", () => {
    describe("me query", () => {
        it("should return current user when authenticated", async () => {
            ...
            const result = await user_resolver_1.userResolver.Query.me(null, null, context);
        ...
        it("should throw error when not authenticated", async () => {
            ...
            await expect(user_resolver_1.userResolver.Query.me(null, null, context)).rejects.toThrow("Not authenticated");
        });
        it("should throw error when user doesn't exist", async () => {
            ...
            await expect(user_resolver_1.userResolver.Query.me(null, null, context)).rejects.toThrow("User not found");
        });
    });
    describe("user query", () => {
        it("should return user by ID", async () => {
            ...
            const result = await user_resolver_1.userResolver.Query.user(null, {
                id: user._id.toString(),
            });
            expect(result).toBeDefined();
            expect(result._id.toString()).toBe(user._id.toString());
        ...
        it("should throw error when user not found", async () => {
            ...
            await expect(user_resolver_1.userResolver.Query.user(null, { id: nonExistentId })).rejects.toThrow("User not found");
        });
    });
    describe("users query", () => {
        it("should return all active users", async () => {
            ...
            const result = await user_resolver_1.userResolver.Query.users();
            expect(result).toBeDefined();
    ...
    describe("updateProfile mutation", () => {
        it("should update user profile when authenticated", async () => {
            ...
            const result = await user_resolver_1.userResolver.Mutation.updateProfile(null, { input }, context);
        ...
        it("should throw error when not authenticated", async () => {
            ...
            await expect(user_resolver_1.userResolver.Mutation.updateProfile(null, { input: { name: "New Name" } }, context)).rejects.toThrow("Not authenticated");
        });
        it("should throw error when user doesn't exist", async () => {
            const context = {
                user: {
            ...
            await expect(user_resolver_1.userResolver.Mutation.updateProfile(null, { input: { name: "New Name" } }, context)).rejects.toThrow("User not found");
        });
        it("should throw validation error for invalid input", async () => {
            ...
            await expect(user_resolver_1.userResolver.Mutation.updateProfile(null, { input: { name: "A" } }, // Less than 2 characters
        ...
        it("should update only provided fields", async () => {
            ...
            // Update only name
            const result = await user_resolver_1.userResolver.Mutation.updateProfile(null, { input: { name: "Updated Name" } }, context);
            expect(result.name).toBe("Updated Name");
    ...
    describe("User type resolvers", () => {
        it("should convert _id to id string", async () => {
            ...
            const id = user_resolver_1.userResolver.User.id(result);
        ...
        it("should convert blood group from DB to GraphQL enum", async () => {
            ...
            const bloodGroup = user_resolver_1.userResolver.User.bloodGroup(result);
        ...
        it("should convert dates to ISO strings", async () => {
            ...
            const result = await user_resolver_1.userResolver.Query.me(null, null, context);
            const createdAt = user_resolver_1.userResolver.User.createdAt(result);
            const updatedAt = user_resolver_1.userResolver.User.updatedAt(result);
            const dateOfBirth = user_resolver_1.userResolver.User.dateOfBirth(result);
